                                            ...
                                            <Row>
                                                ...
                                                <Col xs={12} md={6}>
                                                    <ListGroup variant="flush">
                                                        ...
                                                        <ListGroup.Item>
                                                            <span className="fs-6">Rental Details:</span>
                                                            <div className="mt-2 ps-4">
                                                                <div>
                                                                    <span className="fs-6">Daily Rate:</span>
                                                                    <span className="fs-5 fw-bold ms-2">₹{cars[reserveData.carId].rental_price ? cars[reserveData.carId].rental_price.toLocaleString('en-IN') : '0'}</span>
                                                                </div>
                                                                <div>
                                                                    <span className="fs-6">Total Price:</span>
                                                                    <span className="fs-5 fw-bold ms-2 text-success">₹{reserveData.totalPrice ? reserveData.totalPrice.toLocaleString('en-IN') : '0'}</span>
                                                                </div>
                                                            </div>
                                                        </ListGroup.Item>
                                                    </ListGroup>
